...
// This function loads up the search form page where you try to find books by searching for it.
  bookView.initSearchFormPage = function() {
    resetView();
    $('.search-view').show();
    $('#search-form').on('submit', function(event) {
      // COMMENT: What default behavior is being prevented here?
      // Its prevents the event of reload on submit
      event.preventDefault();
      ...
      // event.target is the information provied by the user. if nothign is provided nothing will happen.
      let book = {
        title: event.target.title.value || '',
        author: event.target.author.value || '',
        isbn: event.target.isbn.value || '',
  ...
  // COMMENT: What is the purpose of this method? 
  // this method fires up the results of the books that were searched for.
  bookView.initSearchResultsPage = function() {
    ...
    // for each book that is searched for append the results to search list in the html.
    module.Book.all.forEach(book => $('#search-list').append(book.toHtml()));
    $('.detail-button a').text('Add to list').attr('href', '/');
    $('.detail-button').on('click', function(e) {
      // COMMENT: Explain the following line of code.
      // this code find the result of the book and then finds the parent of the listener (.book-overlay) and that parent of that parent (.book-container) and the parent of the parent (.book-items) and then finds the book id.
